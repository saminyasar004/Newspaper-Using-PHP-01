            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    <?php
                        ...
                        $end_post = "There are no post found!";
                    }
                    ?>
                    <?php
                    ...
                    ?>
                        <ul class='pagination'>
                            ...
                            if ($total_page > 1) {
                                if ($current_page > 1) {
                            ?>
                                    <li><a href="index.php?current_page=<?php echo ($current_page - 1); ?>">⇽</a></li>
                                <?php
                                }
                                ...
                                ?>
                                    <li class="<?php echo $active; ?>"><a href="index.php?current_page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                <?php
                                }
